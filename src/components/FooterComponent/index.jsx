const FooterComponent = async () => {
  const responseRama = await fetch(`https://api.github.com/users/ramadiaz`);
  const dataRama = await responseRama.json();

  const responseBocil = await fetch(`https://api.github.com/users/Fahry169`);
  const dataBocil = await responseBocil.json();

  return (
    <div className="bg-white">
      <div className="h-96 bg-orange-100"></div>
      <div className="w-full h-44 bg-gradient-to-b from-orange-100 "></div>
      <div className="max-w-screen-xl pt-16 pb-8 lg:py-8 mx-auto w-11/12 lg:w-2/3">
        <div className="md:flex md:justify-between mx-auto">
          <div className="flex flex-col gap-4">
            <div className="mb-6 md:mb-0">
              ...
              >
                <img
                  src={dataRama.avatar_url}
                  className="h-10 me-3 rounded-full"
                  alt={`avatar of ${dataRama.login}`}
                />
            ...
            <div className="mb-6 md:mb-0">
              ...
              >
                <img
                  src={dataBocil.avatar_url}
                  className="h-10 me-3 rounded-full"
                  alt={`avatar of ${dataBocil.login}`}
                />
                <div className="flex flex-col">
                  <span className="text-2xl font-semibold whitespace-nowrap dark:text-white">
                    Fahry Firdaus
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 justify-end sm:mt-0">
            ...
            <a
              href="https://instagram.com/ramadiazr"
              className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
